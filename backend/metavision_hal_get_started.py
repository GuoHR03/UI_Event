...
class CameraThread(QThread):
    ...
    def __init__(self, palette_type="Dark",fps=30,nn_interval_ms=20,target_queue=None,file_path = "C:/Users/tianmu/Downloads/hand_spinner.raw"): #target_queue
        super().__init__()
            ...
            if self.analysis_enabled and self.target_queue is not None:
                if evs.size > 0:
                    try:
                        ...
                        self.target_queue.put_nowait(raw_data)
                    except queue.Full:
                        pass
            time.sleep(0.01)
